...
class OrderManager {
    ...
    async sanity_check() {
        ...
        this.get_ticker(ticker, instrument)
    ...
    async get_ticker(ticker, instrument) {
        let tickLog = instrument['tickLog']

        this.start_position_buy = ticker["buy"] + instrument['tickSize']
        this.start_position_sell = ticker["sell"] - instrument['tickSize']
...
// highest buy lowest buy should be from order book.